...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI,KC_LALT,KC_LCTL,MO(2), KC_ENT,        HYPR_T(KC_SPC),  MO(3), KC_RCTL, KC_RALT, KC_RGUI
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_WORKMAN] = LAYOUT(
  ...
  KC_LSFT, KC_Z, KC_X, KC_M, KC_C, KC_V, KC_MUTE,     XXXXXXX,                                          KC_K, KC_L, KC_COMM, KC_DOT, KC_SLSH, KC_ESC,
                 KC_LGUI,KC_LALT,KC_LCTL,MO(2), KC_ENT,        HYPR_T(KC_SPC),  MO(3), KC_RCTL, KC_RALT, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
